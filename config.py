...
ROOM_BED_CAPACITIES: dict[str, int] = {
    # 기본 4인실. 예외: 2·3병동 x03·x04·x05호 5인실, 3병동 306·307호 2인실, 5병동 502호 1인실.
    # 명부에 지금 있는 방만 적었다 — 비어 있어 명부에 없는 방(2병동 210~212·215호 등)은
    # 확인되는 대로 추가할 것. 병동 허가 병상과의 차이는 화면에 '미확인'으로 나온다.
    # 2병동 5인실은 명부상 5명이 들어 있는 205·206·207호로 잡았다(203·204호는 3~4명).
    **{f"{n}호": 4 for n in (201, 202, 203, 204, 208, 209, 213, 214, 216, 217)},
    ...
    **{f"{n}호": 4 for n in range(1301, 1308)},
}
